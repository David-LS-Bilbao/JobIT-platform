...
function IconCheck() {
  return (
    <svg viewBox="0 0 24 24" fill="none" className="h-5 w-5 text-[#006c49]" aria-hidden="true">
  ...
  return (
    <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05)]">
      ...
      <div
        ...
        aria-valuemax={100}
      >
        <div className="h-full rounded-full bg-[#006591] transition-all" style={{ width: `${pct}%` }} />
      </div>
